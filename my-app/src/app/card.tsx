export default function Card({imageUrl, title, description, link, label}: {
    ...
    return (
        <main
            className="border border-neutral-100 p-2 rounded w-[380px] max-w[380px] mt-4 flex justify-center items-center flex-col">
            ...
            text-center">
                ...
                <div className="text-left mt-2">
                    <p className="text-sm text-neutral-200 mt-5">{description}</p>
                    <a className="text-accent-100 relative" href={link} target="_blank" rel="noopener noreferrer">
                        { label }
